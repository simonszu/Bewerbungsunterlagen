...
\photo[64pt]{picture_hq}                          % '64pt' is the height the picture must be resized to and 'picture' is the name of the picture file; optional, remove the line if not wanted
...
\begin{minipage}{\textwidth}
	...
	\hspace*{5mm}{{\color{firstnamecolor}\includegraphics[width=64pt]{picture_hq}}}\\[3mm]
...
%	}]{azmiele.pdf}
\includepdf[pages=1-,addtotoc={1, section, 1, Arbeitszeugnis ECOFIS GmbH, azecofis} ]{ECOFIS.pdf}
\includepdf[pages=1,addtotoc={1, section, 1, Arbeitszeugnis Sozialforschungsstelle Dortmund, azsfs} ]{SFS.pdf}
\includepdf[pages=1,addtotoc={1, section, 1, Arbeitszeugnis Miele \& Cie. KG, azmiele} ]{Miele.pdf}
